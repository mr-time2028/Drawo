...
type Room struct {
	...
	Language        string
	CategoryID      string // Optional dictionary category used for word suggestions.
	State           RoomState
	MinPlayers      int
	MaxPlayers      int
	...
	MaxRounds       int
	CurrentRound    int
	CurrentDrawerID string   // Runtime drawer authorization hook; the game loop sets this per turn.
